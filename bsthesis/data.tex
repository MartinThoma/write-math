...
\begin{itemize}
    \item Wild-point detection and deleting or replacement of wild points with
          the average of neighboring points\cite{Division1987},
    \item Smoothing can be done in multiple ways. An approach that was used quite
          often is by averaging a point with its neighbors\cite{Groner1966,Division1987,Arakaw1983}.
...
\begin{itemize}
    ...
    \item Curvature\cite{Groner1966,Manke95,ICASSP-94,Guyon1991}
